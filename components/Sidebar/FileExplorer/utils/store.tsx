    ...
    (set, get) => {
      ...
      return {
        ...
        refreshFileTree: () => {
          ...
          fetch(`http://${getHost()}:${getPort()}/api/v1/file-explorer/tree?directory=${directory}`, {
            headers: {
        ...
        createNewFile: async (fileName: string, parentPath?: string) => {
          ...
          try {
            ...
            const response = await fetch(`http://${getHost()}:${getPort()}/api/v1/file-explorer/create-file`, {
              method: 'POST',
              headers: {
        ...
        createNewFolder: async (folderName: string, parentPath?: string) => {
          ...
          try {
            ...
            const response = await fetch(`http://${getHost()}:${getPort()}/api/v1/file-explorer/create-directory`, {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
